...
for (
    ...
    for start_idx in start_indices:
        ...
        initial_price = sp_price[start_idx]

        stock_value = INITIAL_CASH * initial_ratio
        cash = INITIAL_CASH - stock_value

        shares = stock_value / initial_price
        ...
        # Max Drawdown
        portfolio_values = shares * sp_price[start_idx:] + cash
